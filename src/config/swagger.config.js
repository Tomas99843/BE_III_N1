...
const swaggerDefinition = {
    ...
    servers: [
        ...
        {
            url: 'https://adoptme-api.example.com',
    ...
    components: {
        securitySchemes: {
            cookieAuth: {
                ...
                in: 'cookie',
                name: 'coderCookie',
                description: 'Autenticación mediante cookie HTTP-only JWT. Se establece automáticamente al iniciar sesión.'
            }
        },
        schemas: {
            User: {
                ...
                properties: {
                    ...
                    pets: {
                        ...
                        description: 'IDs de mascotas adoptadas por el usuario'
                    },
                    documents: {
                        type: 'array',
                        items: {
                    ...
                    last_connection: {
                        type: 'string',
                        format: 'date-time',
                        description: 'Última conexión del usuario al sistema',
            ...
            Document: {
                ...
                properties: {
                    ...
                    reference: {
                        type: 'string',
                        description: 'Ruta o URL del documento almacenado',
            ...
            Pet: {
                ...
                properties: {
                    ...
                    status: {
                        type: 'string',
                        enum: ['available', 'adopted', 'reserved', 'medical_care'],
            ...
            Adoption: {
                ...
                properties: {
                    ...
                    status: {
                        ...
                        description: 'Estado del proceso de adopción'
                    },
                    notes: {
                        type: 'string',
            ...
            Error: {
                ...
                properties: {
                    status: {
                        type: 'string',
                        example: 'error',
                        description: 'Estado de la respuesta (siempre "error" en errores)'
                    },
                    error: {
                        type: 'string',
            ...
            Success: {
                ...
                properties: {
                    status: {
                        type: 'string',
                        example: 'success',
                        description: 'Estado de la respuesta (siempre "success" en éxito)'
                    },
                    message: {
                        type: 'string',
                    ...
                    data: {
                        type: 'object',
                        description: 'Datos de la respuesta (estructura variable)'
                    }
                }
            }
        },
            ...
            ValidationError: {
                ...
                content: {
                    'application/json': {
                        ...
                        example: {
                            status: 'error',
                            error: 'Datos inválidos. Revisa los campos enviados.',
    ...
    tags: [
        {
            name: 'Users',
            description: 'Operaciones relacionadas con usuarios - **Módulo documentado para entrega**',
            externalDocs: {
                description: 'Ver documentación completa del modelo User',
                url: '#/components/schemas/User'
            }
        },
        {
            name: 'Sessions',
        ...
        {
            name: 'Adoptions',
            description: 'Proceso de adopción de mascotas - **Tests funcionales completos**'
        },
        {
            name: 'Mocks',
            description: 'Generación de datos de prueba para desarrollo'
        }
    ],
    externalDocs: {
        description: 'Documentación del proyecto en GitHub',
        url: 'https://github.com/tu-organizacion/adoptme-api'
    }
};
...
if (!swaggerSpec.paths || Object.keys(swaggerSpec.paths).length === 0) {
    ...
    console.warn('   Asegúrate de que los archivos en src/routes/*.js tengan JSDoc válido.');
}
